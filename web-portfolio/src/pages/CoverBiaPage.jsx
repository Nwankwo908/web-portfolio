...
import coverBiaImage from "../assets/CoverBIA 1.png";
import artboard1a from "../assets/Artboard 1a.png";
import artboard1b from "../assets/Artboard 1b .png";
import artboard1c from "../assets/Artboard 1c.png";
import artboard1d from "../assets/Artboard 1d.png";
import artboard1e from "../assets/Artboard 1e.png";
import artboard1f from "../assets/Artboard 1f.png";
import artboard1g from "../assets/Artboard 1g.png";

const coverBiaArtboards = [
  artboard1a,
  artboard1b,
  artboard1c,
  artboard1d,
...
export default function CoverBiaPage() {
  return (
    <div className="min-h-screen pt-[136px] text-black bg-white app-lift-up">
      <div className="w-full px-4 py-10 sm:py-12 lg:py-16">
        ...
        <header className="mb-12 sm:mb-16">
          ...
          >
            Designed and optimized the "Buy it Again" experience for pro contractors
          </p>
          <p
        ...
        >
          <img
            src={coverBiaImage}
            alt="Cover BIA product overview"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 lg:gap-12 items-start">
            <div>
              <p
                ...
                style={{ fontFamily: "Alte Haas Grotesk, system-ui, sans-serif" }}
              >
                I led the end-to-end UX design of key eCommerce flows for pro contractor users, including the "Buy It Again" (BIA) experience, Empty Cart, Filled Cart, and Add to Quote journeys.
